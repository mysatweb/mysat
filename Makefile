#############################################################################
# Makefile for building: mysat-qt.app/Contents/MacOS/mysat-qt
# Generated by qmake (2.01a) (Qt 4.8.7) on: Wed May 23 13:21:28 2018
# Project:  mysat-qt.pro
# Template: app
# Command: /usr/local/bin/qmake -o Makefile mysat-qt.pro
#############################################################################
...
DIST          = /usr/local/Cellar/qt@4/4.8.7_3/etc/qt4/mkspecs/common/unix.conf \
		...
		mysat-qt.pro
QMAKE_TARGET  = mysat-qt
DESTDIR       = 
TARGET        = mysat-qt.app/Contents/MacOS/mysat-qt
...
all: Makefile mysat-qt.app/Contents/PkgInfo mysat-qt.app/Contents/Resources/empty.lproj mysat-qt.app/Contents/Info.plist mysat-qt.app/Contents/Resources/bitcoin.icns $(TARGET)

$(TARGET): /Users/admin/Desktop/coin/mysat/build/build.h build/ui_sendcoinsdialog.h build/ui_addressbookpage.h build/ui_signverifymessagedialog.h build/ui_aboutdialog.h build/ui_editaddressdialog.h build/ui_transactiondescdialog.h build/ui_overviewpage.h build/ui_sendcoinsentry.h build/ui_askpassphrasedialog.h build/ui_rpcconsole.h build/ui_optionsdialog.h $(OBJECTS)  
	@$(CHK_DIR_EXISTS) mysat-qt.app/Contents/MacOS/ || $(MKDIR) mysat-qt.app/Contents/MacOS/ 
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: mysat-qt.pro  /usr/local/Cellar/qt@4/4.8.7_3/etc/qt4/mkspecs/unsupported/macx-clang-libc++/qmake.conf /usr/local/Cellar/qt@4/4.8.7_3/etc/qt4/mkspecs/common/unix.conf \
		/usr/local/Cellar/qt@4/4.8.7_3/etc/qt4/mkspecs/common/mac.conf \
		/usr/local/Cellar/qt@4/4.8.7_3/etc/qt4/mkspecs/common/gcc-base.conf \
		/usr/local/Cellar/qt@4/4.8.7_3/etc/qt4/mkspecs/common/gcc-base-macx.conf \
		/usr/local/Cellar/qt@4/4.8.7_3/etc/qt4/mkspecs/common/clang.conf \
...
mysat-qt.app/Contents/PkgInfo: 
	@$(CHK_DIR_EXISTS) mysat-qt.app/Contents || $(MKDIR) mysat-qt.app/Contents 
	@$(DEL_FILE) mysat-qt.app/Contents/PkgInfo
	@echo "APPL????" >mysat-qt.app/Contents/PkgInfo
mysat-qt.app/Contents/Resources/empty.lproj: 
	@$(CHK_DIR_EXISTS) mysat-qt.app/Contents/Resources || $(MKDIR) mysat-qt.app/Contents/Resources 
	@touch mysat-qt.app/Contents/Resources/empty.lproj
	
mysat-qt.app/Contents/Info.plist: 
	@$(CHK_DIR_EXISTS) mysat-qt.app/Contents || $(MKDIR) mysat-qt.app/Contents 
	@$(DEL_FILE) mysat-qt.app/Contents/Info.plist
	@sed -e "s,@SHORT_VERSION@,0.7,g" -e "s,@TYPEINFO@,????,g" -e "s,@ICON@,bitcoin.icns,g" -e "s,@EXECUTABLE@,mysat-qt,g" -e "s,@TYPEINFO@,????,g" /usr/local/Cellar/qt@4/4.8.7_3/etc/qt4/mkspecs/unsupported/macx-clang-libc++/Info.plist.app >mysat-qt.app/Contents/Info.plist
mysat-qt.app/Contents/Resources/bitcoin.icns: src/qt/res/icons/bitcoin.icns
	@$(CHK_DIR_EXISTS) mysat-qt.app/Contents/Resources/ || $(MKDIR) mysat-qt.app/Contents/Resources/ 
	@$(DEL_FILE) mysat-qt.app/Contents/Resources/bitcoin.icns
	@$(COPY_FILE) src/qt/res/icons/bitcoin.icns mysat-qt.app/Contents/Resources/bitcoin.icns
dist: 
	@$(CHK_DIR_EXISTS) build/mysat-qt0.7.2 || $(MKDIR) build/mysat-qt0.7.2 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) build/mysat-qt0.7.2/ && $(COPY_FILE) --parents src/qt/locale/bitcoin_en.ts src/qt/locale/bitcoin_ru.ts build/mysat-qt0.7.2/ && $(COPY_FILE) --parents src/qt/macdockiconhandler.mm build/mysat-qt0.7.2/ && $(COPY_FILE) --parents src/qt/bitcoingui.h src/qt/transactiontablemodel.h src/qt/addresstablemodel.h src/qt/optionsdialog.h src/qt/sendcoinsdialog.h src/qt/addressbookpage.h src/qt/signverifymessagedialog.h src/qt/aboutdialog.h src/qt/editaddressdialog.h src/qt/bitcoinaddressvalidator.h src/alert.h src/addrman.h src/base58.h src/bignum.h src/checkpoints.h src/compat.h src/sync.h src/util.h src/uint256.h src/kernel.h src/scrypt_mine.h src/pbkdf2.h src/serialize.h src/strlcpy.h src/main.h src/net.h src/key.h src/db.h src/walletdb.h src/script.h src/init.h src/irc.h src/mruset.h src/json/json_spirit_writer_template.h src/json/json_spirit_writer.h src/json/json_spirit_value.h src/json/json_spirit_utils.h src/json/json_spirit_stream_reader.h src/json/json_spirit_reader_template.h src/json/json_spirit_reader.h src/json/json_spirit_error_position.h src/json/json_spirit.h src/qt/clientmodel.h src/qt/guiutil.h src/qt/transactionrecord.h src/qt/guiconstants.h src/qt/optionsmodel.h src/qt/monitoreddatamapper.h src/qt/transactiondesc.h src/qt/transactiondescdialog.h src/qt/bitcoinamountfield.h src/wallet.h src/keystore.h src/qt/transactionfilterproxy.h src/qt/transactionview.h src/qt/walletmodel.h src/bitcoinrpc.h src/qt/overviewpage.h src/qt/csvmodelwriter.h src/crypter.h src/qt/sendcoinsentry.h src/qt/qvalidatedlineedit.h src/qt/bitcoinunits.h src/qt/qvaluecombobox.h src/qt/askpassphrasedialog.h src/protocol.h src/qt/notificator.h src/qt/qtipcserver.h src/allocators.h src/ui_interface.h src/qt/rpcconsole.h src/version.h src/netbase.h src/clientversion.h src/qt/macdockiconhandler.h build/mysat-qt0.7.2/ && $(COPY_FILE) --parents src/qt/bitcoin.qrc build/mysat-qt0.7.2/ && $(COPY_FILE) --parents src/qt/bitcoin.cpp src/qt/bitcoingui.cpp src/qt/transactiontablemodel.cpp src/qt/addresstablemodel.cpp src/qt/optionsdialog.cpp src/qt/sendcoinsdialog.cpp src/qt/addressbookpage.cpp src/qt/signverifymessagedialog.cpp src/qt/aboutdialog.cpp src/qt/editaddressdialog.cpp src/qt/bitcoinaddressvalidator.cpp src/alert.cpp src/version.cpp src/sync.cpp src/util.cpp src/netbase.cpp src/key.cpp src/script.cpp src/main.cpp src/init.cpp src/net.cpp src/irc.cpp src/checkpoints.cpp src/addrman.cpp src/db.cpp src/walletdb.cpp src/qt/clientmodel.cpp src/qt/guiutil.cpp src/qt/transactionrecord.cpp src/qt/optionsmodel.cpp src/qt/monitoreddatamapper.cpp src/qt/transactiondesc.cpp src/qt/transactiondescdialog.cpp src/qt/bitcoinstrings.cpp src/qt/bitcoinamountfield.cpp src/wallet.cpp src/keystore.cpp src/qt/transactionfilterproxy.cpp src/qt/transactionview.cpp src/qt/walletmodel.cpp src/bitcoinrpc.cpp src/rpcdump.cpp src/rpcnet.cpp src/rpcmining.cpp src/rpcwallet.cpp src/rpcblockchain.cpp src/rpcrawtransaction.cpp src/qt/overviewpage.cpp src/qt/csvmodelwriter.cpp src/crypter.cpp src/qt/sendcoinsentry.cpp src/qt/qvalidatedlineedit.cpp src/qt/bitcoinunits.cpp src/qt/qvaluecombobox.cpp src/qt/askpassphrasedialog.cpp src/protocol.cpp src/qt/notificator.cpp src/qt/qtipcserver.cpp src/qt/rpcconsole.cpp src/noui.cpp src/kernel.cpp src/scrypt-x86.S src/scrypt-x86_64.S src/scrypt_mine.cpp src/pbkdf2.cpp build/mysat-qt0.7.2/ && $(COPY_FILE) --parents src/qt/macdockiconhandler.mm build/mysat-qt0.7.2/ && $(COPY_FILE) --parents src/qt/forms/sendcoinsdialog.ui src/qt/forms/addressbookpage.ui src/qt/forms/signverifymessagedialog.ui src/qt/forms/aboutdialog.ui src/qt/forms/editaddressdialog.ui src/qt/forms/transactiondescdialog.ui src/qt/forms/overviewpage.ui src/qt/forms/sendcoinsentry.ui src/qt/forms/askpassphrasedialog.ui src/qt/forms/rpcconsole.ui src/qt/forms/optionsdialog.ui build/mysat-qt0.7.2/ && $(COPY_FILE) --parents src/qt/locale/bitcoin_en.ts src/qt/locale/bitcoin_ru.ts build/mysat-qt0.7.2/ && (cd `dirname build/mysat-qt0.7.2` && $(TAR) mysat-qt0.7.2.tar mysat-qt0.7.2 && $(COMPRESS) mysat-qt0.7.2.tar) && $(MOVE) `dirname build/mysat-qt0.7.2`/mysat-qt0.7.2.tar.gz . && $(DEL_FILE) -r build/mysat-qt0.7.2
...
distclean: clean
	-$(DEL_FILE) -r mysat-qt.app
	-$(DEL_FILE) Makefile


/Users/admin/Desktop/coin/mysat/build/build.h: FORCE
	cd /Users/admin/Desktop/coin/mysat; /bin/sh share/genbuild.sh /Users/admin/Desktop/coin/mysat/build/build.h
...
qrc_bitcoin.cpp: src/qt/bitcoin.qrc \
		...
		src/qt/res/icons/mysat-16.png \
		src/qt/res/icons/mysat-128.png \
